...
const string strMessageMagic = "scattercoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in scattercoin
    bool fStrictPayToScriptHash = true; // Always active in scattercoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "scattercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "09-17-2014 - Scattercoin Lives! ";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("c3c55c574662cbb476de1e2163a3bb4c70e6c2a13291c8fc7d16e1db9fd0f43b"));
